# title: 星髄の坑道
// =====================================================================
//  星髄の坑道 v2.1 — サバイバル・RPG worked example (Issue #20)
...
=== intro ===
むかし、この山には鉱山があって、たくさんの坑夫（あなをほる人たち）がはたらいていた。
ある日、いちばん深いところをほっていた坑夫たちが、大きな生きものの巣を、ほりあててしまった。
「星喰い」——地面の中で、白く光る石「星髄」を食べて生きている、この山のぬしだ。おこった星喰いに、坑夫が何人も殺された。
親方はこわくなって、いちばん下へおりる階段を石でうめて、かくした。地図も書きなおして、「下の坑道なんて、はじめから無い」ことにした。そして何も無かったふりをして、上のほうだけで仕事をつづけた。
だが、かくしても星喰いはいなくならない。毒の空気とあやしい気配が、だんだん上までのぼってきて——ある朝、坑夫たちはみんな、にげるように山をすてた。それから十二年、だれもこの山に入っていない。

いま、あなたの村では、悪い病気がはやっている。その病気にきく薬は、「星髄」をくだいてせんじたものだけだ。
星髄があるのは、この山のいちばん深いところ——星喰いのいる、あの底だけ。
たったひとりで山に入り、星髄をひとかけら取って、村へ持ち帰る。それが、あなたのやることだ。
-> r_plaza
...
=== look_ghost ===
古いかたちの仕事着を着ている。よく見ると、体のむこうに岩はだが、うっすらすけて見えた。
-> plaza_look
...
{ not ghost_met:
    ~ ghost_met = true
    「星髄かね」おじいさんは、こちらを見もせずに言った。
    体のむこうに、岩がすけて見える。生きている人では、ないらしい。
    「止めはせん。わしらもほったんだ。だがな——下の坑には、もうだれも降りん」
- else:
    おじいさんは、坑口の暗がりをながめている。
}
...
=== talk_lastday ===
「みんなが出ていった朝のことは、上から見とったよ。だれもかれも、うしろをふり返りふり返り、走っていきよった」
...
=== look_rockpile ===
くずれたばかりのように、角の立った岩ばかりだ。上のほうの岩は、どれもういてぐらついている。
-> b5_look

=== look_b5_water ===
細い流れは岩山をさけて、かべぎわの低いすき間へ、まよいなく流れこんでいく。
水が通るなら、その先に道がある。
-> b5_look

=== look_guard ===
こうらは、岩と見分けがつかない。ただ、こうらのつなぎ目だけが、息に合わせて開いたりとじたりしている。
-> b5_look
